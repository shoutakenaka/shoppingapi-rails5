...
ActiveRecord::Base.transaction do
  item1 = Item.find_by(name: 'KATOMOKU muku mini square clock')
  if item1.blank?
    item1 = Item.create!(
  ...
  item2 = Item.find_by(name: 'Dolls RING')
  if item2.blank?
    item2 = Item.create!(
      name: 'Dolls RING',
      description:
  ...
  item3 = Item.find_by(name: 'no/26 Earrings')
  if item3.blank?
    item3 = Item.create!(
      name: 'no/26 Earrings',
      description:
  ...
  item4 = Item.find_by(name: 'iPhone cover')
  if item4.blank?
    item4 = Item.create!(
      name: 'iPhone cover',
      description:
  ...
  item5 = Item.find_by(name: 'Cookie Box')
  if item5.blank?
    item5 = Item.create!(
      name: 'Cookie Box',
      description:
  ...
  accessory = Category.find_or_create_by!(name: 'アクセサリ')
  furniture = Category.find_or_create_by!(name: '家具・生活雑貨')
  mobile_goods = Category.find_or_create_by!(name: 'スマホケース・モバイルグッズ')
  food = Category.find_or_create_by!(name: '食べ物')
  
  item1.update!(category: furniture)
  item2.update!(category: accessory)
  item3.update!(category: accessory)
  item4.update!(category: mobile_goods)
  item5.update!(category: food)
end
